...
#Combined Years (from NCES download)
...
nces2019_readiness <- read_csv('NCES Data/Readiness/(2018-2019) College Readiness.csv') |> clean_names()
...
nces_allYears <- bind_rows(nces2011, 
                           nces2012, 
                           nces2013, 
                           nces2014, 
                           nces2015, 
...
#Trying to Align with College Readiness Data (!!!!english & reading vs ebrw issue)
nces_allYears |> 
  select(year, 
         contains('enrollment'), 
         graduation_rate_4_year, 
