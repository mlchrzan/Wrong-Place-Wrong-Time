...
all_data_gentrify |> 
  ...
  mutate(education_level = str_replace_all(education_level, "percent_educational_attainment_", "")) |>
         #   str_replace(education_level, contains("9th_to"), "Some High School, No Diploma"), 
         # education_level = str_replace(education_level, contains('associates'), "Associate's Degree"))
  ggplot() + 
  geom_line(aes(x = year, 
                y = percent_at_level, 
