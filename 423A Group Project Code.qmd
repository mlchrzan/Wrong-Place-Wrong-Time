...
```{r viz-all-4}
all_data_gentrify |> 
  filter(edu_level_delta > 0, 
         housing_delta > 0) |> 
  ggplot() + 
  geom_point(aes(x = rent_delta, 
                 y = value_delta, 
                 color = housing_delta, 
                 size = edu_level_delta)) +
  ...
  annotate("text", 
           label = "Note: Years 2012, 2015-2017 not included\ndue to having negative changes\nin educational attainment and housing built",
           x = 30,
           y = -6000,
           hjust = 1,
           size = 2.25,
